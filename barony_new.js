...
function fetch(request, response, type, err, contents)
{
  ...
  function ready(err, extract)
  {
    ...
    begin(response, type, err, contents, id, extract);
  }
}

// Ronseal.
function begin(response, type, err, contents, id, extract)
{
...
function fetchManor(response, type, err, contents, id, data, person)
{
  ...
  {
    if(err) throw err;
    fetchCounty(response, type, err, contents, id, data, person, manor);
  }
}
